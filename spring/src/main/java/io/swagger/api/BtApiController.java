...
@Controller
public class BtApiController implements BtApi {

    public ResponseEntity<List<ZodObject>> returnBtObjects(@ApiParam(value = "pass an optional search string for looking up zod objects") @RequestParam(value = "searchString", required = false) String searchString,
