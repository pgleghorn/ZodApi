...
@Api(value = "kt", description = "the kt API")
public interface KtApi {

    @ApiOperation(value = "return kt objects", notes = "return kt objects", response = ZodObject.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/kt",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<ZodObject>> returKtObjects(@ApiParam(value = "pass an optional search string for looking up zod objects") @RequestParam(value = "searchString", required = false) String searchString,
